...
OUT_PROCESSED = BASE_DIR /"data/input/masterdata_for_modeling_lstm.parquet"
...
def main():
    ...
    SCALER_PATH = PREP_OUT / "scalers_lstm.joblib"
...
# ------------------------------
    ...
    META_PATH = PREP_OUT / "meta_lstm.json"
