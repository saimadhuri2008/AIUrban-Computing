...
INPUT = Path(r"C:\AIurban-planning\data\interim\master\wards_master.parquet")
OUT_PARQUET = Path(
    r"C:\AIurban-planning\statistical_inference\data\input\wards_masterdata.parquet"
)
OUT_GPKG = Path(
    r"C:\AIurban-planning\data\processed\master_data\wards_masterdata.parquet"
)
